					...
					<div class="accordion-item">
						...
						<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								...
								<div class="row mb-2">
									<a name="btn_trasladar" id="btn_trasladar" class="btn btn-warning" href="http://localhost/mvc_estructure/Controllers/MovimientosController.php?action=traslado" role="button">Realizar Traslado</a>
								</div>
								<div class="row mb-2">
									<a name="btn_descargar" id="btn_descargar" class="btn btn-warning" href="http://localhost/mvc_estructure/Controllers/MovimientosController.php?action=salida" role="button">Descargar Provision</a>
								</div>
								<div class="row mb-2">
									<a name="btn_ingCajaLata" id="btn_ingCajaLata" class="btn btn-warning" href="http://localhost/mvc_estructure/Controllers/MovimientosController.php?action=cajalata" role="button">Ingresar Caja Lata</a>
								</div>
							</div>
						</div>
					</div>
